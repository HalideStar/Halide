...
.LBB97_9:                               # %f1.v0_loop
	...
	jne	.LBB97_9
	jmp	.LBB97_10
.LBB97_14:                              # %f0.v0_after_loop.thread
	movq	%rbx, %rdi
	callq	halide_malloc@PLT
	movq	%rax, %rbx
.LBB97_10:
...
# BB#11:                                # %f2.v0.v0_loop.preheader
	...
	pxor	%xmm13, %xmm13
	movaps	.LCPI97_3(%rip), %xmm7
	movaps	.LCPI97_4(%rip), %xmm6
	movdqa	.LCPI97_5(%rip), %xmm10
	movdqa	.LCPI97_6(%rip), %xmm11
	.align	16, 0x90
.LBB97_12:                              # %f2.v0.v0_loop
                                        # =>This Inner Loop Header: Depth=1
	leal	(%r11,%rax), %ecx
	movd	%ecx, %xmm0
	...
	movslq	52(%rsp), %rbp
	insertps	$16, (%r14,%rbp,4), %xmm5
	movdqa	%xmm1, %xmm0
	punpckhbw	%xmm0, %xmm0    # xmm0 = xmm0[8,8,9,9,10,10,11,11,12,12,13,13,14,14,15,15]
	insertps	$32, (%r14,%r10,4), %xmm5
	movslq	60(%rsp), %rsi
	insertps	$48, (%r14,%rsi,4), %xmm5
	movss	(%rbx,%r9,4), %xmm4
	movslq	36(%rsp), %rdi
	insertps	$16, (%rbx,%rdi,4), %xmm4
	pslld	$31, %xmm0
	movslq	40(%rsp), %rcx
	insertps	$32, (%rbx,%rcx,4), %xmm4
	movaps	%xmm6, %xmm3
	divps	%xmm5, %xmm3
	movss	(%rbx,%rdx,4), %xmm5
	movslq	44(%rsp), %rdx
	insertps	$16, (%rbx,%rbp,4), %xmm5
	insertps	$32, (%rbx,%r10,4), %xmm5
	insertps	$48, (%rbx,%rsi,4), %xmm5
	mulps	%xmm7, %xmm5
	blendvps	%xmm3, %xmm5
	insertps	$48, (%rbx,%rdx,4), %xmm4
	movss	(%r14,%r9,4), %xmm0
	insertps	$16, (%r14,%rdi,4), %xmm0
	insertps	$32, (%r14,%rcx,4), %xmm0
	insertps	$48, (%r14,%rdx,4), %xmm0
	movups	%xmm5, 16(%r15,%r8,4)
	...
	movdqa	%xmm1, %xmm0
	blendvps	%xmm3, %xmm4
	movups	%xmm4, (%r15,%r8,4)
	jne	.LBB97_12
.LBB97_13:                              # %f2.v0.v0_after_loop
	movq	%rbx, %rdi
